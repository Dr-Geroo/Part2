...
class Admin extends User {
    ...
    private List<Course> findCoursePrerequisites(String courseCode) {
...
class Student extends User {
    ...
    /**
     * Registers the student for a specified course, if eligible.
     *
     * @param admin      The administrator responsible for course management.
     * @param courseCode The code of the course to register for.
     */

    public void registerForCourse(Admin admin, String courseCode) {
        Course course = admin.findCourseByCode(courseCode);
        if (course != null && canRegisterForCourse(course)) {
            registeredCourses.add(course);
            System.out.println(getUsername() + " successfully registered for " + courseCode);
        } else {
            System.out.println("Unable to register for " + courseCode);
        }
    }
...
public class Part2 {
    public static void main(String[] args) {
        Admin admin = new Admin("Farajalla", "Farajalla");
        admin.registerFirstAdmin();

        admin.createStudent("student1", "student1pass");
        admin.createLecturer("lecturer1", "lecturer1pass");
        ...
        switch (userType) {
            case 1:
                ...
                Admin loggedInAdmin = admin.loginAdmin(adminUsername, adminPassword);

                if (loggedInAdmin != null) {
                    adminMenu(loggedInAdmin, scanner);
                } else {
                    System.out.println("Admin login failed. Exiting program.");
                }
                break;
            ...
            case 2:
                ...
                Student loggedInStudent = admin.loginStudent(studentUsername, studentPassword);

                if (loggedInStudent != null) {
                    studentMenu(loggedInStudent, admin, scanner);
                } else {
                    System.out.println("Student login failed. Exiting program.");
                }
                break;
            ...
            case 3:
                ...
                Lecturer loggedInLecturer = admin.loginLecturer(lecturerUsername, lecturerPassword);

                if (loggedInLecturer != null) {
                    lecturerMenu(loggedInLecturer, admin, scanner);
                } else {
                    System.out.println("Lecturer login failed. Exiting program.");
                }
                break;
    ...
    private static void adminMenu(Admin loggedInAdmin, Scanner scanner) {
        while (true) {
            System.out.println("\nAdmin Menu:");
            ...
            switch (choice) {
                case 1:
                    ...
                    String studentPassword = scanner.nextLine();
                    loggedInAdmin.createStudent(studentUsername, studentPassword);
                    break;
                ...
                case 2:
                    ...
                    String lecturerPassword = scanner.nextLine();
                    loggedInAdmin.createLecturer(lecturerUsername, lecturerPassword);
                    break;
                ...
                case 3:
                    ...
                    Lecturer lecturerForCourse = loggedInAdmin.findLecturerByUsername(lecturerUsernameForCourse);
                    loggedInAdmin.createCourse(courseCode, lecturerForCourse, null, credits);
                    break;

                case 4:
                    System.out.print("Enter course code to assign: ");
                    String courseCodeToAssign = scanner.nextLine();
                    Course courseToAssign = loggedInAdmin.findCourseByCode(courseCodeToAssign);
                    System.out.print("Enter lecturer username to assign: ");
                    String lecturerUsernameToAssign = scanner.nextLine();
                    Lecturer lecturerToAssign = loggedInAdmin.findLecturerByUsername(lecturerUsernameToAssign);
                    loggedInAdmin.assignCourseToLecturer(courseToAssign, lecturerToAssign);
                    break;

                case 5:
                    loggedInAdmin.viewAllStudentsAndLecturers();
                    break;

                case 6:
                    System.out.print("Enter CSV filename to save: ");
                    String saveFileName = scanner.nextLine();
                    loggedInAdmin.saveToCSV(saveFileName);
                    break;

                case 7:
                    System.out.print("Enter CSV filename to load: ");
                    String loadFileName = scanner.nextLine();
                    loggedInAdmin = Admin.loadFromCSV(loadFileName);
                    break;
    ...
    private static void studentMenu(Student loggedInStudent, Admin admin, Scanner scanner) {
        while (true) {
            System.out.println("\nStudent Menu:");
            System.out.println("1. Register for Course");
            System.out.println("2. View Registered Courses");
            System.out.println("3. View Past, Current, and Future Subjects");
            ...
            switch (choice) {
                case 1:
                    ...
                    loggedInStudent.registerForCourse(admin, courseCodeToRegister);
                    break;

                case 2:
                    System.out.println("Registered Courses:");
                    for (Course course : loggedInStudent.getRegisteredCourses()) {
                        System.out.println("- " + course.getcourseCode());
                    }
                    break;

                case 3:
                    loggedInStudent.viewSubjects();
                    break;
    ...
    private static void lecturerMenu(Lecturer loggedInLecturer, Admin admin, Scanner scanner) {
        while (true) {
            System.out.println("\nLecturer Menu:");
            ...
            switch (choice) {
                case 1:
                    loggedInLecturer.viewStudentsInAssignedCourses();
                    break;
